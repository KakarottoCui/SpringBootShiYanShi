var GET_TABLE_URL = '/user/teacher';
var EDIT_DATA_URL = 'http://localhost:8080/user/teacher/add.html?teacherId=';
var DELETE_DATA_URL = "http://localhost:8080/user/teacher/delete";

var TABLE_LIST_NAME = 'teacherList';
...
//        height: 312,
        ...
        parseData: function (res) { //res 即为原始返回的数据
            return {
                ...
                "data": res.data.teacherList //解析数据列表
            }
        },
        page: true,
        cols: [
